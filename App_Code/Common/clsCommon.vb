...
Public Class clsCommon
    ...
    Public Function ValidateLogin() As Boolean
        Try
            If String.IsNullOrEmpty(Convert.ToString(HttpContext.Current.Session("LoginUserName"))) OrElse String.IsNullOrEmpty(Convert.ToString(HttpContext.Current.Session("RoleId"))) OrElse String.IsNullOrEmpty(Convert.ToString(HttpContext.Current.Session("CompanyId"))) OrElse String.IsNullOrEmpty(Convert.ToString(HttpContext.Current.Session("LoginUserName"))) Then
                Return False
            Else
                Return True
            End If
