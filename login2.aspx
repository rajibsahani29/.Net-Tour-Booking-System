<%@ Page Title="Easyways Software" Language="VB" AutoEventWireup="false" CodeFile="login2.aspx.vb" Inherits="login2" %>
...
<body class="login" style="overflow: hidden;">
  ...
  <div class="user-pass">
       ...
       <asp:HiddenField ID="hdnCompanyId" runat="server" Value="2" />
