<%@ Page Language="VB" MasterPageFile="../main.master" AutoEventWireup="false" CodeFile="accom_docs.aspx.vb" Inherits="accom_docs"  ValidateRequest="false"%>
...
rel="popover" data-original-title="Assign Accommodation to a Route and Stage">Assign Accommodation to Route and Stage</a> 
    ...
    <h1 class="page-title">Add & Delete Accommodation Documents - Staff Use Only</h1>
    <div class="container_12 clearfix leading">
        ...
        <table class="basic-table"  ;>
				<thead>
					<tr>
						<th style="width:100%; ">Add Accommodation Documents</th>
               ...
               <asp:Panel ID="pnlForm" runat="server" DefaultButton="BUT_Add_New_Accom_Doc">
                   ...
                   <div class="clearfix">
                            ...
                            <div class="clearfix">
                                ...
                                <div class="form-label">Google Drive Link</div>
                               
                               
                                <div class="form-input">
                                    <asp:TextBox ID="TB_Accom_Doc_Link" name="accom_doc_link" required="required" placeholder="Google Drive Link" runat="server"></asp:TextBox>   
                          ...
                          <div class="clearfix">
                               ...
                               <div class="form-input">
                                    <asp:TextBox ID="TB_Accom_Doc_Desc" name="accom_doc_desc" required="required" placeholder="Small Description" runat="server"></asp:TextBox>   
                            ...
                            <div class="form-action clearfix">
                                <asp:Button ID="BUT_Add_New_Accom_Doc" UseSubmitBehavior="true" class="fr"  runat="server" 
                                    Text="Add New Document" Enabled="False" />
        ...
        <table class="basic-table"  ;>
				<thead>
					<tr>
						<th style="width:100%; ">View & Delete Existing Documents</th>
          ...
          <asp:GridView ID="GridView1"  Width="98%" runat="server" CellPadding="5" ForeColor="#ABC4DC" GridLines="Horizontal"  
              ...
              <HeaderStyle BackColor="#ABC4DC" Font-Bold="True" Font-Size="Large"  ForeColor="White" Height="25px" />
                <Columns>
                    ...
                    <asp:BoundField DataField="doc_link" HeaderText="Google Drive Link" ReadOnly="true" />
                    <asp:BoundField DataField="name" HeaderText="Small Description" ReadOnly="true" />
