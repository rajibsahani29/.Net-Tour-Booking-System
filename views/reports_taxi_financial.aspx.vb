...
Partial Class reports_taxi_financial
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If Not Page.IsPostBack Then
                ...
                objFunction.FillDropDownByDataSet(DROP_Taxi, dstExtra)
                DROP_Taxi.Items.Insert(0, New ListItem("Select Extra", ""))
    ...
    Protected Sub BindGridview()
        ...
        Try
            ...
            Dim strSearchByExtra As String = objFunction.ReturnString(DROP_Taxi.SelectedItem.Value)

            Dim dstReportsTaxiFinancial As DataSet = (New clsDLBookingReport()).GetReportsTaxiFinancial(intCompanyId, strSearchByFromDate, strSearchByToDate, strSearchByExtra)

            GRID_Taxi_Financial.DataSource = dstReportsTaxiFinancial
