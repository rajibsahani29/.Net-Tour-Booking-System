<%@ Page Language="VB" MasterPageFile="../main.master" AutoEventWireup="false" CodeFile="reports_taxi_financial.aspx.vb" Inherits="reports_taxi_financial"  ValidateRequest="false"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <h1 class="page-title" style="text-align:center;">Taxi Financial Summary Report</h1>
 ...
 <section class="grid_12">
         ...
         <div class="form-label">Taxi</div>
                               
                               
          <div class="form-input">
               <asp:DropDownList ID="DROP_Taxi" style="font-size:18px; margin-top:2%;margin-left:2%;" runat="server" required>  
               </asp:DropDownList>                    
             </div>
