<%@ Page Language="VB" MasterPageFile="../main.master" AutoEventWireup="false" CodeFile="accom_options_diary_event.aspx.vb" Inherits="accom_options_diary_event"  ValidateRequest="false"%>
...
rel="popover" data-original-title="Add & Edit Diary Event Status">Add & Edit Diary Event Status</a> 
    ...
    <h1 class="page-title">Add & Edit Diary Event Status (e.g. Full or Low Availability)</h1>
     ...
     <div class="form has-validation">
        ...
        <table class="basic-table"  ;>
				<thead>
					<tr>
						<th style="width:100%; ">Diary Event Status (e.g. Full or Low Availability)</th>
                    ...
                    <asp:Panel ID="pnlForm" runat="server" DefaultButton="BUT_Add__Diary_Event_Status">
                            <div class="clearfix">
                          
                                <div class="form-label">Status Name</div>
                               
                               
                                <div class="form-input">
                                    <asp:TextBox ID="TB_accom_diary_event" name="accom_diary_event" required="required" placeholder="Status Name" runat="server"></asp:TextBox>   
                 ...
                 <div class="clearfix">
                                ...
                                <div class="form-input" >
                                  <asp:DropDownList ID="DROP_color" style="font-size:18px; margin-top:2%;margin-left:2%;" runat="server">
                            ...
                            <div class="form-action clearfix">
                                <asp:Button ID="BUT_Add__Diary_Event_Status" UseSubmitBehavior="true" class="fr"  runat="server" Text="Add New Diary Event Status" />
        ...
        <table class="basic-table"  ;>
				<thead>
					<tr>
						<th style="width:100%; ">Edit Diary Event Status</th>
              ...
              <HeaderStyle BackColor="#00A19C" Font-Bold="True" Font-Size="Medium"  ForeColor="White" Height="25px" />
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Color">
                        <ItemTemplate>
                        <asp:Label ID="LABEL_Color" runat="server" Text='<%# Eval("color_id")%>'/>
                        </ItemTemplate>
                        <EditItemTemplate>
                        <asp:DropDownList ID="DROP_GridColor" style="font-size:18px; margin-top:2%;margin-left:2%;" runat="server" SelectedValue='<%# Eval("color_id")%>'>
                            <asp:ListItem Text="Red" Value="Red"></asp:ListItem>
                            <asp:ListItem Text="Yellow" Value="Yellow"></asp:ListItem>
                        </asp:DropDownList>
                        </EditItemTemplate>
