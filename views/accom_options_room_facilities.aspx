<%@ Page Language="VB" MasterPageFile="../main.master" AutoEventWireup="false" CodeFile="accom_options_room_facilities.aspx.vb" Inherits="accom_options_room_facilities"  ValidateRequest="false"%>
...
rel="popover" data-original-title="Add & Edit Diary Event Status">Add & Edit Diary Event Status</a> 
    ...
    <h1 class="page-title">Add & Edit Room Facilities (e.g. En-suite)</h1>
    ...
    <div class="form has-validation">
        ...
        <table class="basic-table"  ;>
				<thead>
					<tr>
						<th style="width:100%; ">Add Room Facilities (e.g. En-suite)</th>
                    ...
                    <asp:Panel ID="pnlForm" runat="server" DefaultButton="BUT_Add_Room_Facilities">
                            <div class="clearfix">
                          
                                <div class="form-label">Room Facilities Name</div>
                               
                               
                                <div class="form-input">
                                    <asp:TextBox ID="TB_accom_room_facilites" name="accom_room_facilities" required="required" placeholder="Room Facilities Name" runat="server"></asp:TextBox>   
                            ...
                            <div class="form-action clearfix">
                                <asp:Button ID="BUT_Add_Room_Facilities" UseSubmitBehavior="true" class="fr"  runat="server" Text="Add New Room Facilities" />
        ...
        <table class="basic-table"  ;>
				<thead>
					<tr>
						<th style="width:100%; ">Edit Room Facilities</th>
