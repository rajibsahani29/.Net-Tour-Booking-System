<%@ Page Language="VB" MasterPageFile="../main.master" AutoEventWireup="false" CodeFile="accom_diary_view2.aspx.vb" Inherits="accom_diary_view2"  ValidateRequest="false"%>
...
<script type="text/javascript">
    ...
    $("#<%= DROP_Stage.ClientID %>, #<%= TB_From_Date.ClientID %>").change(function () {
    ...
    function GetCalendarData(DateValue) {
        ...
        if (fromDate != "") {
            ...
            var doaction = "getAccomDiaryCalander2";
            ...
            $.post('GetAjaxData.aspx', { DoAction: doaction, StageId: stageId, FromDate: fromDate }, function (responseText) {
