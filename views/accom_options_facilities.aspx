<%@ Page Language="VB" MasterPageFile="../main.master" AutoEventWireup="false" CodeFile="accom_options_facilities.aspx.vb" Inherits="accom_options_facilities"  ValidateRequest="false"%>
...
rel="popover" data-original-title="Add & Edit Diary Event Status">Add & Edit Diary Event Status</a> 
    ...
    <h1 class="page-title" >Add & Edit Accommodation Facilities (e.g. Car Park)</h1>
      ...
      <div class="container_12 clearfix leading">
       ...
       <div class="form has-validation">
        ...
        <table class="basic-table"  ;>
				<thead>
					<tr>
						<th style="width:100%; ">Add Accommodation Facilities (e.g. Car Park)</th>
						
					</tr>
				</thead>
            </table>
           </div>    
                    <asp:Panel ID="pnlForm" runat="server" DefaultButton="BUT_Add_Accom">
                            <div class="clearfix">
                          
                                <div class="form-label">Accommodation Facility Name</div>
                               
                               
                                <div class="form-input">
                                    <asp:TextBox ID="TB_accom_name" name="accom_name" required="required" placeholder="Accommodation Facility Name" runat="server"></asp:TextBox>   
                            ...
                            <div class="form-action clearfix">
                                <asp:Button ID="BUT_Add_Accom" UseSubmitBehavior="true" class="fr"  runat="server" Text="Add New Accommodation Facility" />
        ...
        <table class="basic-table"  ;>
				<thead>
					<tr>
						<th style="width:100%; ">Edit Accommodation Facilities</th>
