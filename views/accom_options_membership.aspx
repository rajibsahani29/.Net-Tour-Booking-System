<%@ Page Language="VB" MasterPageFile="../main.master" AutoEventWireup="false" CodeFile="accom_options_membership.aspx.vb" Inherits="accom_options_membership"  ValidateRequest="false"%>
...
rel="popover" data-original-title="Add & Edit Diary Event Status">Add & Edit Diary Event Status</a> 
    ...
    <h1 class="page-title" >Add & Edit Accommodation Memberships (e.g. Visit Scotland)</h1>
      ...
      <div class="container_12 clearfix leading">
        ...
        <table class="basic-table"  ;>
				<thead>
					<tr>
						<th style="width:100%; ">Add Accommodation Memberships (e.g. Visit Scotland)</th>
                    ...
                    <asp:Panel ID="pnlForm" runat="server" DefaultButton="BUT_Add__Membership">
                            <div class="clearfix">
                          
                                <div class="form-label">Accommodation Membership</div>
                               
                               
                                <div class="form-input">
                                    <asp:TextBox ID="TB_accom_membership" name="accom_membership" required="required" placeholder="Accommodation Membership Name" runat="server"></asp:TextBox>   
                            ...
                            <div class="form-action clearfix">
                                <asp:Button ID="BUT_Add__Membership" UseSubmitBehavior="true" class="fr"  runat="server" Text="Add New Accommodation Membership" />
        ...
        <table class="basic-table"  ;>
				<thead>
					<tr>
						<th style="width:100%; ">Edit Accommodation Memberships</th>
