<%@ Page Language="VB" MasterPageFile="../main.master" AutoEventWireup="false" CodeFile="reports_client_report1.aspx.vb" Inherits="reports_client_report1"  ValidateRequest="false"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <h1 class="page-title" style="text-align:center;">Clients with Multiple Bookings Report</h1>
...
<div style="overflow-x:auto;">
    <asp:GridView ID="GRID_Client_Report1" Width="98%" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None"
        AllowPaging="true" pagesize="2000" AutoGenerateColumns="false" DataKeyNames="ClientId" OnSelectedIndexChanging="GRID_Client_Report1_SelectedIndexChanged"
        emptydatatext="No Records Found" ShowHeaderWhenEmpty="True" OnPageIndexChanging="GRID_Client_Report1_PageIndexChanging">
