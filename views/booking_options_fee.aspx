<%@ Page Language="VB" MasterPageFile="../main.master" AutoEventWireup="false" CodeFile="booking_options_fee.aspx.vb" Inherits="booking_options_fee"  ValidateRequest="false"%>
...
rel="popover" data-original-title="Add & Edit Distances between Stages">Add & Edit Distances</a> 
   ...
   <h1 class="page-title">Edit Booking Fees</h1>
      ...
      <div class="container_12 clearfix leading">
     	 ...
     	 <div class="form has-validation" style="display:none;">
                <div class="clearfix" style="background:#808080;color:#DAE5EB;">
        <table class="basic-table"  ;>
				<thead>
					<tr>
						<th style="width:100%; ">Add Booking Fee</th>
                    ...
                    <asp:Panel ID="pnlForm" runat="server" DefaultButton="BUT_Add_Booking_Fee">
                            <div class="clearfix">
                          
                                <div class="form-label">Total Number of People</div>
                               
                               
                                <div class="form-input">
                                    <asp:TextBox ID="TB_Booking_Total_No_People" name="booking_fee" required="required" placeholder="1" ReadOnly="true" runat="server">1</asp:TextBox>   
                 ...
                 <div class="clearfix">
                                ...
                                <div class="form-label">Fee Total</div>
                               
                                   <div class="form-input">
                                    <asp:TextBox ID="TB_Booking_Fee_Total" name="booking_fee_total" required="required" placeholder="Enter Fee Total" runat="server"></asp:TextBox>  
...
<div class="form-label" style="width:100%;color:red; text-align:center;">  NOTE: Please enter once only.</div>

                            <div class="form-action clearfix">
                                <asp:Button ID="BUT_Add_Booking_Fee" UseSubmitBehavior="true" class="fr"  runat="server" Text="Add New Booking Fee" />
        ...
        <table class="basic-table"  ;>
				<thead>
					<tr>
						<th style="width:100%; ">Edit Booking Fee</th>
          ...
          <asp:GridView ID="GridView1" Width="98%" runat="server" CellPadding="5" ForeColor="#ABC4DC" GridLines="Horizontal"  
                AllowPaging="true" pagesize="2000" AutoGenerateColumns="false" DataKeyNames="id,total_num" 
              ...
              <HeaderStyle BackColor="#ABC4DC" Font-Bold="True" Font-Size="Large"  ForeColor="White" Height="25px" />
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Total Number of People">
                        <ItemTemplate>
                        <asp:Label ID="LABEL_TotalNum" runat="server" Text='<%# Eval("total_num")%>'/>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Fee Total">
                        <ItemTemplate>
                        <asp:Label ID="LABEL_FeeTotal" runat="server" Text='<%# Eval("fee_total")%>'/>
                        </ItemTemplate>
                        <EditItemTemplate>
                        <asp:TextBox ID="TB_FeeTotal" runat="server" Text='<%# Eval("fee_total")%>'/>
                        </EditItemTemplate>
                    </asp:TemplateField>
