<%@ Page Language="VB" MasterPageFile="../main.master" AutoEventWireup="false" CodeFile="reports_baggage_invoiced.aspx.vb" Inherits="reports_baggage_invoiced"  ValidateRequest="false"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <h1 class="page-title" style="text-align:center;">Baggage Invoiced (15th of each month)</h1>
         ...
         <div class="form-label">Year</div>
          ...
          <asp:DropDownList ID="DROP_Year" style="font-size:18px; margin-top:2%;margin-left:2%;" runat="server">    
             ...
             <div class="clearfix">
                                  ...
                                  <div class="form-input">
                                   <asp:DropDownList ID="DROP_Baggage" style="font-size:18px; margin-top:2%;margin-left:2%;" runat="server">
                                  </asp:DropDownList>
                                </div>
...
<div style="overflow-x:auto;">
    <asp:GridView ID="GRID_Baggage_Invoiced" Width="98%" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None"
        AllowPaging="true" pagesize="2000" AutoGenerateColumns="false" DataKeyNames="booking_id" 
        emptydatatext="No Records Found" ShowHeaderWhenEmpty="True" 
        OnSelectedIndexChanging="GRID_Baggage_Invoiced_SelectedIndexChanged" OnPageIndexChanging="GRID_Baggage_Invoiced_PageIndexChanging">
