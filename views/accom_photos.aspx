<%@ Page Language="VB" MasterPageFile="../main.master" AutoEventWireup="false" CodeFile="accom_photos.aspx.vb" Inherits="accom_photos"  ValidateRequest="false"%>
...
rel="popover" data-original-title="Assign Accommodation to a Route and Stage">Assign Accommodation to Route and Stage</a> 
    ...
    <h1 class="page-title">Add & Delete Accommodation Imagery</h1>
    <div class="container_12 clearfix leading">
        ...
        <table class="basic-table"  ;>
				<thead>
					<tr>
						<th style="width:100%; ">Add Accommodation Imagery</th>
                   ...
                   <div class="clearfix">
                            ...
                            <div class="clearfix">
                                ...
                                <div class="form-label">Upload a New Photo</div>
                               
                              
                                <div class="form-input">
                                 <asp:FileUpload ID="FILE_Photo" style="margin-top:2%;margin-left:2%;"  runat="server" />
                          ...
                          <div class="clearfix">
                                ...
                                <div class="form-input">
                                    ...
                                    <asp:CheckBox ID="CHK_Main_Image"  style="margin-left:2%;"  runat="server"  />
                            ...
                            <div class="form-action clearfix">
                                <asp:Button ID="BUT_Add_New_Image"   class="fr"  runat="server" 
                                    Text="Add New Image" Enabled="False" />
        ...
        <table class="basic-table"  ;>
				<thead>
					<tr>
						<th style="width:100%; ">View & Delete Existing Photos</th>
            ...
            <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" 
                AllowPaging="true" pagesize="2000" AutoGenerateColumns="false" DataKeyNames="id,photoLoc" 
