<%@ Page Language="VB" MasterPageFile="../main.master" AutoEventWireup="false" CodeFile="reports_eval_easyways.aspx.vb" Inherits="reports_eval_easyways"  ValidateRequest="false"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <h1 class="page-title" style="text-align:center;">Easyways Evaluation Report</h1>
...
<div style="overflow-x:auto;">
    <asp:GridView ID="GRID_Eval_Easyways" Width="98%" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None"
        AllowPaging="true" pagesize="2000" AutoGenerateColumns="false" DataKeyNames="id" OnSelectedIndexChanging="GRID_Eval_Easyways_SelectedIndexChanged"
        emptydatatext="No Records Found" ShowHeaderWhenEmpty="True" OnPageIndexChanging="GRID_Eval_Easyways_PageIndexChanging">
