<%@ Page Language="VB" MasterPageFile="../main.master" AutoEventWireup="false" CodeFile="accom_options_breakfast.aspx.vb" Inherits="accom_options_breakfast"  ValidateRequest="false"%>
...
rel="popover" data-original-title="Add & Edit Diary Event Status">Add & Edit Diary Event Status</a> 
    ...
    <h1 class="page-title">Add & Edit Breakfast Types (e.g. No Breakfast)</h1>
      ...
      <div class="container_12 clearfix leading">
        ...
        <table class="basic-table"  ;>
				<thead>
					<tr>
						<th style="width:100%; ">Add Breakfast Types (e.g. No Breakfast)</th>
                    ...
                    <asp:Panel ID="pnlForm" runat="server" DefaultButton="BUT_Add__Breakfast">
                            <div class="clearfix">
                          
                                <div class="form-label">Breakfast Types</div>
                               
                               
                                <div class="form-input">
                                    <asp:TextBox ID="TB_accom_breakfast" name="accom_breakfast" required="required" placeholder="Breakfast Type Name" runat="server"></asp:TextBox>   
                            ...
                            <div class="form-action clearfix">
                                <asp:Button ID="BUT_Add__Breakfast" UseSubmitBehavior="true" class="fr"  runat="server" Text="Add New Breakfast Type Options" />
        ...
        <table class="basic-table"  ;>
				<thead>
					<tr>
						<th style="width:100%; ">Edit Breakfast Types</th>
...
<div style="overflow-x:auto;">
          <asp:GridView ID="GridView1" Width="98%" runat="server" CellPadding="5" ForeColor="#00A19C" GridLines="Horizontal" 
                AllowPaging="true" PageSize="2000" AutoGenerateColumns="false" DataKeyNames="id,descx" 
