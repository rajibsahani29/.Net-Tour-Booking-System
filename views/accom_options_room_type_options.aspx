<%@ Page Language="VB" MasterPageFile="../main.master" AutoEventWireup="false" CodeFile="accom_options_room_type_options.aspx.vb" Inherits="accom_options_room_type_options"  ValidateRequest="false"%>
...
rel="popover" data-original-title="Add & Edit Diary Event Status">Add & Edit Diary Event Status</a> 
    ...
    <h1 class="page-title">Add & Edit Room Options</h1>
     ...
     <div class="form has-validation">
        ...
        <table class="basic-table"  ;>
				<thead>
					<tr>
						<th style="width:100%; ">Add Room Options</th>
                    ...
                    <asp:Panel ID="pnlForm" runat="server" DefaultButton="BUT_Add_Room_Type_Options">
                            <div class="clearfix">
                          
                                <div class="form-label">Room Type Options Name</div>
                               
                               
                                <div class="form-input">
                                    <asp:TextBox ID="TB_accom_room_type_options" name="accom_room_type_options" required="required" placeholder="Room Type Options Name" runat="server"></asp:TextBox>   
                            ...
                            <div class="form-action clearfix">
                                <asp:Button ID="BUT_Add_Room_Type_Options" UseSubmitBehavior="true" class="fr"  runat="server" Text="Add New Room Type Options" />
        ...
        <table class="basic-table"  ;>
				<thead>
					<tr>
						<th style="width:100%; ">Edit Room Options</th>
