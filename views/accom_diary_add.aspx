<%@ Page Language="VB" MasterPageFile="../main.master" AutoEventWireup="false" CodeFile="accom_diary_add.aspx.vb" Inherits="accom_diary_add"  ValidateRequest="false"%>
...
rel="popover" >View Walkers Diary</a> 
    ...
    <h1 class="page-title">Add & Edit Accommodation Diary Event</h1>
...
<div class="form has-validation">
      ...
      <div class="clearfix" style="background:#5E249F;color:#DAE5EB;">
        <table class="basic-table"  ;>
				<thead>
					<tr>
						<th style="width:100%; ">Add Accom Diary Event</th>
           ...
           <asp:Panel ID="pnlForm" runat="server" DefaultButton="BUT_Add_Accom_Diary_Event">
               ...
               <div class="clearfix">
                ...
                <div class="clearfix">
                              ...
                              <div class="clearfix">
                                  ...
                                  <div class="form-input" >
                                  <asp:DropDownList ID="DROP_Statue" style="font-size:18px; margin-top:2%;margin-left:2%;" runat="server">
                                  </asp:DropDownList>
             ...
             <div class="form-label"></div>
                <div class="form-action clearfix">
                                <asp:Button ID="BUT_Add_Accom_Diary_Event" UseSubmitBehavior="true" class="fr"  runat="server" Text="Add Accommodation Diary Event" />
    ...
    <div class="clearfix" style="background:#5E249F;color:#DAE5EB;">
        <table class="basic-table"  ;>
				<thead>
					<tr>
						<th style="width:100%; ">View & Edit Accom Diary Event</th>
     ...
     <div class="clearfix">
             <div class="form-label"></div>
                <div class="form-action clearfix">
                                <asp:Button ID="BUT_View" UseSubmitBehavior="true" class="fr"  runat="server" Text="View & Edit Accommodation Diary Event" />
           ...
           <asp:GridView ID="GRID_Accom_Diary_Edit" Width="98%" runat="server" CellPadding="5" ForeColor="#00A19C" GridLines="Horizontal" 
              ...
              <Columns>
                ...
                <asp:TemplateField HeaderText="Status">
                    <ItemTemplate>
                    <asp:Label ID="LABEL_GridStatus" runat="server" Text='<%# Eval("AccomDiaryEventStatusName")%>'/>
                    </ItemTemplate>
                    <%--<EditItemTemplate>
                        <asp:HiddenField ID="hdnDiaryEventStatus" runat="server" Value='<%# Eval("accom_diaryevent_status_id")%>'></asp:HiddenField>
              ...
              <RowStyle BackColor="#F7F6F3" ForeColor="#333333" HorizontalAlign="Center" Font-Size="X-Small" Height="50px"/>
