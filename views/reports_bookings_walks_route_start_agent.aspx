<%@ Page Language="VB" MasterPageFile="../main.master" AutoEventWireup="false" CodeFile="reports_bookings_walks_route_start_agent.aspx.vb" Inherits="reports_bookings_walks_route_start_agent"  ValidateRequest="false"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <h1 class="page-title" style="text-align:center;">Walks by Route / Start Date / Agent</h1>
...
<div id="DIV_bookings_walks_route_start_agent" runat="server">
<%--<table id="reports" >
    <tr>
        <th colspan="9"> <asp:Label ID="LABEL_Route_Name" runat="server"  Text="Route Name"></asp:Label></th>
    </tr>
...
<asp:Label ID="LABEL_Cancelled" runat="server" Text="No"></asp:Label>
    ...
    <asp:GridView ID="GRID_Walks_Route_Start_Agent" Width="98%" runat="server" CellPadding="4" ForeColor="#333333" GridLines="Horizontal"
        AllowPaging="true" pagesize="2000" AutoGenerateColumns="false" DataKeyNames="id" 
        emptydatatext="No Records Found" ShowHeaderWhenEmpty="True" 
        OnSelectedIndexChanging="GRID_Walks_Route_Start_Agent_SelectedIndexChanged" OnPageIndexChanging="GRID_Walks_Route_Start_Agent_PageIndexChanging"
        >
